...
urlpatterns = patterns('',
    ...
    url(r'^my_open_posts/(?P<num_items>\d+)/(?P<sorting>.*)/$', views.my_open_posts, name='my_open_posts'),
    url(r'^my_locked_posts/(?P<num_items>\d+)/(?P<sorting>.*)/$', views.my_locked_posts, name='my_locked_posts'),
    url(r'^my_responded_posts/(?P<num_items>\d+)/(?P<sorting>.*)/$', views.my_responded_posts, name='my_responded_posts'),
    url(r'^all_buying_posts/(?P<num_items>\d+)/(?P<sorting>.*)/$', views.all_buying_posts, name='all_buying_posts'),
    url(r'^all_selling_posts/(?P<num_items>\d+)/(?P<sorting>.*)/$', views.all_selling_posts, name='all_selling_posts'),
    ...
    url(r'^category_selling_posts/(?P<category_id>\d+)/(?P<num_items>\d+)/(?P<sorting>.*)/$', views.category_selling_posts, name='category_selling_posts'),
    url(r'^category_buying_posts/(?P<category_id>\d+)/(?P<num_items>\d+)/(?P<sorting>.*)/$', views.category_buying_posts, name='category_buying_posts'),
    url(r'^hashtag_selling_posts/(?P<hashtag_id>\d+)/(?P<num_items>\d+)/(?P<sorting>.*)/$', views.hashtag_selling_posts, name='hashtag_selling_posts'),
    url(r'^hashtag_buying_posts/(?P<hashtag_id>\d+)/(?P<num_items>\d+)/(?P<sorting>.*)/$', views.hashtag_buying_posts, name='hashtag_buying_posts'),
