...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Posting.picture'
        db.add_column(u'market_posting', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Posting.picture'
        db.delete_column(u'market_posting', 'picture')
    ...
    models = {
        ...
        u'market.posting': {
            ...
            'date_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 29, 0, 0)'}),
            'date_posted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 29, 0, 0)'}),
