...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.rating'
        db.alter_column(u'market_userprofile', 'rating', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'UserProfile.rating'
        db.alter_column(u'market_userprofile', 'rating', self.gf('django.db.models.fields.IntegerField')())
