...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Posting.blobstore_key'
        db.add_column(u'market_posting', 'blobstore_key',
                      self.gf('django.db.models.fields.TextField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Posting.blobstore_key'
        db.delete_column(u'market_posting', 'blobstore_key')
