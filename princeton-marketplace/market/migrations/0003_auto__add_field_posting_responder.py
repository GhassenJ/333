...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Posting.responder'
        db.add_column(u'market_posting', 'responder',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='responder', null=True, to=orm['auth.User']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Posting.responder'
        db.delete_column(u'market_posting', 'responder_id')
