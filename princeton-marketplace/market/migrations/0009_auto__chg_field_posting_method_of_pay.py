...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Posting.method_of_pay'
        db.alter_column(u'market_posting', 'method_of_pay', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Posting.method_of_pay'
        db.alter_column(u'market_posting', 'method_of_pay', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        u'market.posting': {
            ...
            'blobstore_key': ('django.db.models.fields.TextField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['market.Category']"}),
            'date_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 3, 0, 0)'}),
            'date_posted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 19, 0, 0)'}),
            ...
            'method_of_pay': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '2'}),
